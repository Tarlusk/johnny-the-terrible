...
public class ControlProvider extends InputProvider{
	...
	public Command attackLeft = new BasicCommand("attackLeft");
	public Command attackRight = new BasicCommand("attackRight");
	public Command attackUp = new BasicCommand("attackUP");
	public Command attackDown = new BasicCommand("attackDown");
	...
	public ControlProvider(Input input) {
        ...
        this.bindCommand(new MouseButtonControl(0), attackUp);
		
        this.bindCommand(new KeyControl(Input.KEY_LEFT), attackLeft);
        this.bindCommand(new KeyControl(Input.KEY_RIGHT), attackRight);
        this.bindCommand(new KeyControl(Input.KEY_DOWN), attackDown);
        this.bindCommand(new KeyControl(Input.KEY_UP), attackUp);
